...
for (const path of paths) {
  ...
  const commands = [
    ...
    `snarkjs powersoftau contribute pot16_0000.ptau pot16_0001.ptau --name=\"Contribution\" -v`,
    `snarkjs powersoftau prepare phase2 pot16_0001.ptau pot16_final.ptau -v`,
    `snarkjs groth16 setup circuit.r1cs pot16_final.ptau circuit_0000.zkey -v`,
    ...
    `rm circuit_0000.zkey circuit.r1cs pot16_0000.ptau pot16_0001.ptau pot16_final.ptau`,
    `rm -rf circuit_js`,
